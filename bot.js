...
return;
 ...
 await conn.sendMessage(msg.key.remoteJid, config.ALIVE_REPLY_ONE, MessageType.text);

return;
      case 'alivebutton2':

 await conn.sendMessage(msg.key.remoteJid, config.ALIVE_REPLY_TWO, MessageType.text);
