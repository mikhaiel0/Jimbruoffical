...
╰────────────────╯`
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(web.data), MessageType.image, {mimetype: Mimetype.jpg , caption: Config.JINN})
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(web.data), MessageType.image, {mimetype: Mimetype.png , caption: Config.JINN})
