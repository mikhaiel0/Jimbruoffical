...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    Jimbrootan.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    Jimbrootan.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
