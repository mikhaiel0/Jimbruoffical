...
let wt = Config.WORKTYPE == 'public' ? false : true

Jimbru.addCommand({ pattern: 'play ?(.*)', fromMe: wt,  deleteCommand: false, desc: Lang.SONG_DESC}, (async (message, match) => {
