...
if (Config.WORKTYPE == 'private') {
    ...
    jimbrootan.addCommand({ pattern: 'mp4 ?(.*)', fromMe: true, desc: Lang.MP4,  deleteCommand: false}, async (message, match) => {
    ...
    jimbrootan.addCommand({ pattern: 'mp4 ?(.*)', fromMe: false, desc: Lang.MP4}, async (message, match) => {
