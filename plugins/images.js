...
const Lang = Language.getString('jimbroottan');

if (Config.WORKTYPE == 'private') {

    Jimbru.addCommand({pattern: 'anime', fromMe: true, desc: Lang.ANIM_DESC}, (async (message, match) => {
    ...
    Jimbru.addCommand({pattern: 'anime', fromMe: false, desc: Lang.ANIM_DESC}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: Config.Config.JINN})
